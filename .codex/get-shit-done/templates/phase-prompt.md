...
<!-- For checkpoint task examples and patterns, see @/var/www/html/emais/.codex/get-shit-done/references/checkpoints.md -->
...
See `/var/www/html/emais/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/var/www/html/emais/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/var/www/html/emais/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
