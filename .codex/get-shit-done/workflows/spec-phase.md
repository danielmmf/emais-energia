...
```bash
INIT=$(node "/var/www/html/emais/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/var/www/html/emais/.codex/get-shit-done/templates/spec.md.
