...
```markdown
Read /var/www/html/emais/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: /var/www/html/emais/.codex/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /var/www/html/emais/.codex/agents/gsd-ui-checker.md for instructions.
