...
```bash
INIT=$(node "/var/www/html/emais/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/var/www/html/emais/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
