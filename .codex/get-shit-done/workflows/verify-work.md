...
<template>
@/var/www/html/emais/.codex/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/var/www/html/emais/.codex/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/var/www/html/emais/.codex/get-shit-done/workflows/transition.md`.
...
- Follow @/var/www/html/emais/.codex/get-shit-done/workflows/diagnose-issues.md
