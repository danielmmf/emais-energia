...
<required_reading>
@/var/www/html/emais/.codex/get-shit-done/references/ai-frameworks.md
@/var/www/html/emais/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /var/www/html/emais/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/var/www/html/emais/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /var/www/html/emais/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /var/www/html/emais/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /var/www/html/emais/.codex/agents/gsd-eval-planner.md for instructions.
