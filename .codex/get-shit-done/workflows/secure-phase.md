...
```
Agent(
  prompt="Read /var/www/html/emais/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/var/www/html/emais/.codex/get-shit-done/templates/SECURITY.md`
