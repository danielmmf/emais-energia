...
<reference>
@/var/www/html/emais/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/var/www/html/emais/.codex/get-shit-done/references/user-profiling.md` to load:
