...
Use template from `/var/www/html/emais/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/var/www/html/emais/.codex/get-shit-done/templates/UI-SPEC.md`
