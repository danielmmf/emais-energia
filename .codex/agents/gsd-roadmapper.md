...
Reference full template: `/var/www/html/emais/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/var/www/html/emais/.codex/get-shit-done/templates/state.md`.
