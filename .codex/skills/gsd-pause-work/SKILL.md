...
<execution_context>
@/var/www/html/emais/.codex/get-shit-done/workflows/pause-work.md
</execution_context>
...
Read and execute `/var/www/html/emais/.codex/get-shit-done/workflows/session-report.md` end-to-end.
