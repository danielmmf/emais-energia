...
- @/var/www/html/emais/.codex/get-shit-done/workflows/complete-milestone.md (main workflow)
- @/var/www/html/emais/.codex/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
