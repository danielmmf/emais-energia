...
<execution_context>
@/var/www/html/emais/.codex/get-shit-done/workflows/manager.md
...
Read and execute `/var/www/html/emais/.codex/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
