...
```markdown
Read /var/www/html/emais/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /var/www/html/emais/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /var/www/html/emais/.opencode/agents/gsd-ui-checker.md for instructions.
