...
<required_reading>
@/var/www/html/emais/.opencode/get-shit-done/references/user-story-template.md
@/var/www/html/emais/.opencode/get-shit-done/references/spidr-splitting.md
@/var/www/html/emais/.opencode/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/var/www/html/emais/.opencode/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/var/www/html/emais/.opencode/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/var/www/html/emais/.opencode/get-shit-done/references/spidr-splitting.md`. Briefly:
