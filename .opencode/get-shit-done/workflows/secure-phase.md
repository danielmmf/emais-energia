...
```
Agent(
  prompt="Read /var/www/html/emais/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/var/www/html/emais/.opencode/get-shit-done/templates/SECURITY.md`
