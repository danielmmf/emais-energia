...
Key references:
- @/var/www/html/emais/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/var/www/html/emais/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/var/www/html/emais/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/var/www/html/emais/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/var/www/html/emais/.opencode/get-shit-done/USER-PROFILE.md" "/var/www/html/emais/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /var/www/html/emais/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/var/www/html/emais/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/var/www/html/emais/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /var/www/html/emais/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /var/www/html/emais/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /var/www/html/emais/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /var/www/html/emais/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /var/www/html/emais/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/var/www/html/emais/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /var/www/html/emais/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /var/www/html/emais/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /var/www/html/emais/.opencode/AGENTS.md
```
