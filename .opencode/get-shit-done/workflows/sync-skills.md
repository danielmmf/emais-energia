...
INSTALL_JS_GLOBAL="/var/www/html/emais/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /var/www/html/emais/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
