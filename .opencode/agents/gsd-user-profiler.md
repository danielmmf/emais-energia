...
<reference>
@/var/www/html/emais/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/var/www/html/emais/.opencode/get-shit-done/references/user-profiling.md` to load:
