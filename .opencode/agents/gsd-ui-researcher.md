...
Use template from `/var/www/html/emais/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/var/www/html/emais/.opencode/get-shit-done/templates/UI-SPEC.md`
