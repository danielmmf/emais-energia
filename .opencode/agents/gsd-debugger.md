...
<required_reading>
@/var/www/html/emais/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/var/www/html/emais/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /var/www/html/emais/.opencode
                  → checks /var/www/html/emais/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /var/www/html/emais/.opencode/get-shit-done
                  → writes to /var/www/html/emais/.opencode/get-shit-done/hooks/
...
@/var/www/html/emais/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/var/www/html/emais/.opencode/get-shit-done/references/common-bug-patterns.md
